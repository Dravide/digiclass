...
class CurhatSiswaManagement extends Component
{
    ...
    public function updateCurhat()
    {
        ...
        try {
            ...
            $this->selectedCurhat->update([
                ...
                'ditangani_oleh' => Auth::user()->guru->nama_guru ?? Auth::user()->name
            ]);

            DB::commit();

            $this->showAlertMessage('success', 'Curhat berhasil ditangani!');
    ...
    public function render()
    {
        ...
        return view('livewire.guru.curhat-siswa-management', [
