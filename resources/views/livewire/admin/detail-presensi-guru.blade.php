<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Detail Presensi Guru</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('rekap-presensi-guru') }}">Rekap Presensi Guru</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title mb-0">Informasi Guru</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td>: 
                                        @if($guru->mataPelajaran)
                                            <span class="badge bg-primary">{{ $guru->mataPelajaran->nama_mata_pelajaran }}</span>
                                        @else
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="card widget-flat">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3 mb-3 text-success">{{ $statistikDetail['hari_kerja'] ?? 0 }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <div class="card widget-flat">
                <div class="card-body text-center">
                    <div class="float-end">
                        <i class="mdi mdi-clock-check widget-icon bg-success-lighten text-success"></i>
                    </div>
                    <h5 class="text-muted fw-normal mt-0">Tepat Waktu</h5>
                    <h3 class="mt-3 mb-3 text-success">{{ $statistikDetail['tepat_waktu'] ?? 0 }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card widget-flat">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3 mb-3 text-warning">{{ $statistikDetail['terlambat'] ?? 0 }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card widget-flat">
                <div class="card-body text-center">
                    <div class="float-end">
                        <i class="mdi mdi-percent widget-icon bg-primary-lighten text-primary"></i>
                    </div>
                    <h5 class="text-muted fw-normal mt-0">Kehadiran</h5>
                    <h3 class="mt-3 mb-3 text-primary">{{ $statistikDetail['persentase_kehadiran'] ?? 0 }}%</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title mb-0">Filter Data Presensi</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Tanggal Mulai -->
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="date" wire:model.live.debounce.500ms="searchTanggal" class="form-control">
                        </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <h4 class="text-muted">Tidak ada data presensi</h4>
                            <p class="text-muted">Belum ada data presensi untuk guru ini pada periode yang dipilih.</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <!-- Loading State -->
    <div wire:loading wire:target="applyFilter,updatedTanggalMulai,updatedTanggalSelesai,updatedFilterJenis,updatedFilterStatus" class="text-center">
